...
func main() {
	...
	fmt.Printf(`::set-output name=latest_tag::%s`, latestTag)
	fmt.Printf(`::set-output name=new_major=::%s`, newMajor)
	fmt.Printf(`::set-output name=new_v_major=::v%s`, newMajor)
	fmt.Printf(`::set-output name=new_minor=::%s`, newMinor)
	fmt.Printf(`::set-output name=new_v_minor=::v%s`, newMinor)
	fmt.Printf(`::set-output name=new_patch=::%s`, newPatch)
	fmt.Printf(`::set-output name=new_v_patch=::v%s`, newPatch)
}
