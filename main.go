...
func main() {
	...
	fmt.Println(fmt.Sprintf(`::set-output name=latest_tag::%s ::set-output name=new_major=::%s ::set-output name=new_minor=::%s ::set-output name=new_patch=::%s ::set-output name=new_v_major=::v%s ::set-output name=new_v_minor=::v%s ::set-output name=new_v_patch=::v%s`, latestTag, newMajor, newMinor, newPatch, newMajor, newMinor, newPatch))
